...
{
    [Serializable]
    public class ToonDetailerAltSettings
    {
    ...
    [DisallowMultipleRendererFeature("Toon Detailer Alt")]
    public class ToonDetailerAlt : ScriptableRendererFeature
    {
        ...
        [SerializeField] private ToonDetailerAltSettings m_Settings = new ToonDetailerAltSettings();
        ...
        private ToonDetailerPassAlt m_ToonDetailerPass = null;
        private DepthMaskPassAlt m_DepthMaskPass = null;
        ...
        {
            m_ToonDetailerPass = new ToonDetailerPassAlt("Toon Detailer Alt");
            if(m_Settings.UseMask) m_DepthMaskPass = new DepthMaskPassAlt("Toon Detailer Alt Depth Mask");
        }
        ...
        public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
        {
            ...
            m_DepthShader = Shader.Find("Hidden/INabStudio/ToonDetailerAlt/DepthMask");
