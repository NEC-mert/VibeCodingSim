...
namespace INab.ToonDetailerAlt.URP
{
    ...
    [VolumeRequiresRendererFeatures(typeof(ToonDetailerAlt))]
    [SupportedOnRenderPipeline(typeof(UniversalRenderPipelineAsset))]
    public sealed class ToonDetailerVolumeComponentAlt : VolumeComponent, IPostProcessComponent
    {
        public ToonDetailerVolumeComponentAlt()
        {
